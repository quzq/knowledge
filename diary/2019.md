...
# 2019-10-01 Tue
  ...
  scp
    download
      scp -r tanawari.poc.web.enhance:/mnt/tanawari_poc/Query_img/test2/cyber-user01/ryohan /mnt/c/compressed_/mnt/tanawari_poc/Query_img/test2/cyber-user01
...
# 2019-09-18 Wed
  ...
  ime
    全角入力から半角入力への切り替えができない
      全角で英数字を入力し、F10押下して確定すると治る
...
# 2019-08-21 Wed
  ...
  チューリング・テスト
    あり機会が知的かどうか（AI的かどうか）を判定するためのテスト
  AI
    第1回AIブーム
      1956-1974 推論と探索の時代
    第2回AIブーム
...
# 2019-06-25 Tue
  ...
  CORS
    Cross-Origin Resource Sharing。オリジン間リソース共有。CSRF等のセキュリティ攻撃を避けるため、ブラウザは異なるオリジンへのアクセス制限をかけているが、CORESはこの制約を一部解除する仕組み。
  http-origin
